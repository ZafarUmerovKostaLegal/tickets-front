...
export { getStatuses, getPriorities, getTickets, getTicket, createTicket, updateTicket, archiveTicket, getComments, addComment, updateComment, getAttachmentUrl, invalidateTicketStaticCache, } from './api';
