...
export const ROUTE_ACCESS_MATRIX: RouteAccessExpectation[] = [
    ...
    { path: '/correspondence/outgoing/new', persona: 'employee', expectUrl: /\/correspondence\/outgoing\/new$/ },
    { path: '/correspondence/outgoing/preview', persona: 'employee', expectUrl: /\/correspondence\/outgoing\/(new|preview)$/ },
...
export const ALL_APP_PATHS = [
    ...
    '/correspondence/outgoing/preview',
    '/kosta-daily',
    '/kosta-legal-ai',
    '/rules',
    '/help',
