...
function mapGatewayPushToItem(raw: Record<string, unknown>): NotificationItem | null {
    ...
    private connect(): void {
        ...
        this.ws.onmessage = (event: MessageEvent) => {
            ...
            if (data.type === 'notification' && data.notification != null && typeof data.notification === 'object') {
                const item = mapGatewayPushToItem(data.notification as Record<string, unknown>);
                if (item)
