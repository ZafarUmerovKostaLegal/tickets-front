export type TimeTabId = 'users' | 'projects' | 'expenses' | 'timesheet' | 'reports' | 'statistics' | 'invoices' | 'settings' | 'clients';
export type ProjectType = 'Время и материалы' | 'Фиксированная ставка' | 'Без бюджета' | 'Пакет часов';
